  ...
  Future<void> _silence(ChannelComment comment) async {
    ...
    final confirmed = await showDialog<bool>(
      ...
      builder: (dialogContext) => AlertDialog(
        ...
        title: Text(
          text.threadStopTitle(comment.authorUsername ?? text.threadThemObject),
        ),
        content: Text(text.threadStopBody),
        actions: [
          TextButton(
          ...
          FilledButton(
            ...
            child: Text(text.threadStopThem),
          ),
        ],
      ),
    );
      ...
      builder: (context, _) {
        ...
        return Scaffold(
          appBar: AppBar(
            ...
            title: Text(AppText.of(context).threadTitle),
          ),
          body: Column(
            children: [
                        ...
                        child: TextField(
                          ...
                          decoration: InputDecoration(
                            hintText: widget.channel.hasCurrentKey
                                ? AppText.of(context).threadCommentHint
                ...
                if (comment.opened)
                  ...
                  Row(
                    children: [
                      ...
                      Text(
                        AppText.of(context).threadEncryptedNoKeyHere,
            ...
            PopupMenuButton<String>(
              ...
              itemBuilder: (_) => [
                  ...
                  PopupMenuItem(
                    ...
                    child: Text(
                      mine
                          ...
                          : AppText.of(context).commonRemove,
                ...
                if (canSilence)
                  PopupMenuItem(
                    value: 'silence',
                    child: Text(AppText.of(context).threadStopThemPosting),
                  ),
              ],
            ),
        ],
      ...
      child: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            Text(AppText.of(context).threadEmptyTitle, style: theme.textTheme.titleMedium),
            const SizedBox(height: PrivioSpacing.xs),
            Text(
              AppText.of(context).threadEmptyBody,
